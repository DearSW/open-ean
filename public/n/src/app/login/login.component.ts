...
export class LoginComponent implements OnInit {
    ...
    // @验证码的文本状态、计数器、定时器
    verificationTxtCode: boolean = false;
    verificationCodeCount: number = 0;
    ...
    field_height: any = 440; // @背景图片高度和宽度
    ...
    // @画图占位
    placeImg() {
        let ctx = this.el.nativeElement.querySelector('.mycanvas').getContext('2d');
